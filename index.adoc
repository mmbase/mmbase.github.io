...
== Introduction
MMBase is a Content Management System that was relatively popular in the zero's mainly in the Netherlands. It was originally developed at https://www.vpro.nl/[VPRO] (https://github.vpro.nl/vpro[github], https://github.vpro.nl/npo-poms[this too])
